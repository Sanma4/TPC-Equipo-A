...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="dgvTratamientos" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table table-bordred table-striped" OnSelectedIndexChanged="">
        <Columns>
